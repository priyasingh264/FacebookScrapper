# post to scrap : https://www.facebook.com/urbanladder/photos/a.947076545302763/4230617770281941/
...
driver.find_element_by_xpath("(//*[@class='m9osqain jq4qci2q a3bd9o3v'])[1]").send_keys("8968344197")
driver.find_element_by_xpath("(//*[@class='m9osqain jq4qci2q a3bd9o3v'])[2]").click()
driver.find_element_by_xpath("(//*[@class='m9osqain jq4qci2q a3bd9o3v'])[2]").send_keys("93581413")
...
# Number of people who shared the post

number_of_share = driver.find_element_by_xpath("(//*[@class='gtad4xkn'])[2]//span//div//span").text
add_data_to_excel(4, 6, number_of_share)


# Name of people who shared the post
driver.find_element_by_xpath("(//*[@class='gtad4xkn'])[2]//span//div//span").click()
time.sleep(3)

count_names = len(
    driver.find_elements_by_xpath("(//*[@class='gmql0nx0 l94mrbxd p1ri9a11 lzcic4wl aahdfvyu hzawbc8m'])"))
print(count_names)

list_of_names = " "
url_of_id = " "
for i in range(1, count_names + 1):
    checkAllName = "(//*[@class='gmql0nx0 l94mrbxd p1ri9a11 lzcic4wl aahdfvyu hzawbc8m'])" + "[" + str(i) + "]/span/a"
    list_of_names = list_of_names + ', ' + driver.find_element_by_xpath(checkAllName).text
    url_of_id = url_of_id + ", " + driver.find_element_by_xpath(checkAllName).get_attribute("href")
add_data_to_excel(4, 7, list_of_names)
add_data_to_excel(4, 8, url_of_id)
